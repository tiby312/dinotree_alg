...
pub fn create_collision_list<'a,A:Axis,N:Node + Send+Sync,D:Send+Sync>
                (tree:&mut DinoTree<A,N>,func:impl Fn(&mut <N::T as HasInner>::Inner,&mut <N::T as HasInner>::Inner)->Option<D>+Send+Sync)->CollisionList<D>
...
impl<D:Send+Sync> CollisionList<D>{
    
    pub fn for_every_pair_par_mut(&mut self,func:impl Fn(&mut D)+Send+Sync+Copy){
